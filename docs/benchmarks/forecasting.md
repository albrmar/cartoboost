...
| `forecasting_m5_full_roster_sample.json` | Legacy maintained artifact | `statsforecast_autoets` remains the maintained winner at RMSE 2.525734; CartoBoost lag RMSE is 2.678097. |
