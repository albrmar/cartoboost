...
def make_shap_explainer(
    ...
    **kwargs: Any,
    ...
    SHAP is an optional dependency. Install it with ``geoboost[explain]`` or
    ...
    if sparse_sets is not None:
        ...
        explainer.geoboost_sparse_adapter = adapter
        return explainer
...
def _import_shap() -> Any:
    try:
        ...
        raise ImportError(
            ...
            "Install it with `pip install geoboost[explain]` or `pip install shap`."
        ) from exc
    return shap
