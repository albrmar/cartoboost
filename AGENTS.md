...
- Keep examples, docs, and public benchmark narratives aligned with the NYC taxi domain: pickup/dropoff zones, `PULocationID`, `DOLocationID`, taxi trips, fare, duration, trip distance, and hour/day features. Do not introduce freight, truckload, carrier, shipper, brokerage, provider, or lane-style examples unless explicitly requested.
